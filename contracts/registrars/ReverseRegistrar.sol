...
contract ReverseRegistrar is Controllable, IReverseRegistrar {
     ...
     */
    constructor(IRegistry registryAddr) {
        registry = registryAddr;

        // Assign ownership of the reverse record to our deployer
        ReverseRegistrar oldRegistrar = ReverseRegistrar(registryAddr.owner(ADDR_REVERSE_NODE));
    ...
    /**
     * @dev Transfers ownership of the reverse record associated with the
     *      calling account.
    ...
    /**
     * @dev Sets the `name()` record for the reverse record associated with
