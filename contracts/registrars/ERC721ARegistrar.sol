...
contract ERC721ARegistrar is IRegistrar, Controllable, Pausable, ERC721A {
    ...
    function mint(address to, uint256 quantity) public virtual live onlyController whenNotPaused {
    ...
    function registerOnly(
        ...
        if (_exists(tokenId)) {
            ...
            address oldOwner = ERC721A.ownerOf(tokenId);
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view returns (bool) {
        ...
        return _isSenderApprovedOrOwner(approvedAddress, owner, spender) || isApprovedForAll(owner, spender);
    }
}
