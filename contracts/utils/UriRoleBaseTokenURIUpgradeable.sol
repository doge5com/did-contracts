 ...
 */
abstract contract UriRoleBaseTokenURIUpgradeable is AccessControlEnumerableUpgradeable {
    ...
    function __UriRoleBaseTokenURI_init(string memory _baseTokenURI) internal onlyInitializing {
        __UriRoleBaseTokenURI_init_unchained(_baseTokenURI);
    }

    function __UriRoleBaseTokenURI_init_unchained(string memory _baseTokenURI) internal onlyInitializing {
